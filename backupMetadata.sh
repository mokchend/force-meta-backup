#!/bin/bash
# S:\code\dotfiles\force-meta-backup\backupMetadata.sh
...
rsync -av --progress /code/dotfiles/force-meta-backup/* ${DATA01_PATH}/${alias} --exclude .git
#cp -Rp /workspace/force-meta-backup/* ${DATA01_PATH}/${alias}

cp /code/dotfiles/envs/build.${alias}.properties ${DATA01_PATH}/${alias}/build.properties
